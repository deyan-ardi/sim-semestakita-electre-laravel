...
<head>
    ...
    <title>{{ config('mitra.name') }} - Konfirmasi Pergantian Email</title>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        request pergantian akun email yang terhubung ke
                                                                        akun Semesta Kita Anda, silahkan tekan tombol
                                                                        dibawah
                                                                        ini untuk melakukan verifikasi email baru Anda
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
