...
<head>
    ...
    <title>{{ config('mitra.name') }} - Tagihan Baru</title>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Tagihan baru {{ $deskripsi }} sebesar
                                                                        @currency($total_tagihan) telah
                                                                        dibuat untuk Anda.Anda dapat melihat detail
                                                                        tagihan melalui menu tagihan pada aplikasi
                                                                        Semesta Kita.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#26A4D3;background:#6cc4a1;border-width:0px;display:inline-block;border-radius:50px;width:auto"><a
                                                                            href="https://semestakita.id/mitra"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;border-style:solid;border-color:#6cc4a1;border-width:15px 30px 15px 30px;display:inline-block;background:#6cc4a1;border-radius:50px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center">Lihat
                                                                            Selengkapnya di Semesta Kita</a></span></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                                                        Mohon jangan membayar lewat dari tenggat waktu
                                                                        yang diberikan</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>{{ config('mitra.name') }}</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Email ini dutujukan untuk {{ $user }}
                                                                        karena
                                                                        Email anda terdaftar sebagai Anggota
                                                                        {{ config('mitra.name') }}<br></p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td style="padding:0;Margin:0;font-size:0px"
                                                                    align="left"><img class="adapt-img"
                                                                        src="https://semestakita.id/assets/landing/img/logo.png"
                                                                        alt="Logo Semesta Kita"
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="139" height="36"></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>Semesta
                                                                            Kita</strong>, All Rights Reserved.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;font-size:12px">
                                                                        Semesta Kita adalah nama bisnis terdaftar dan
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;font-size:12px">
                                                                        Semesta Kita dan Logo Semesta Kita adalah merek
                                                                        dagang terdaftar yang dilindungi Undang-Undang.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td
                                                                    ...
                                                                    <div style="text-align:center"><a
                                                                            href="mailto:info@semestakita.id?subject=unsubscribe"
                                                                        ...
                                                                        <span>·</span>
                                                                        <a href="https://semestakita.id/kebijakan-privasi"
                                                                            ...
                                                                            Policy</a>
                                                                        <span>·</span>
                                                                        <a href="https://semestakita.id/syarat-ketentuan"
                                                                            ...
                                                                            & Conditions</a>
                                                                        <span>·</span>
                                                                        <a href="https://semestakita.id"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:12px">FAQ's</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
