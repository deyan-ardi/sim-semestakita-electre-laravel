...
<head>
    ...
    <title>{{ config('mitra.name') }} - Informasi Kode OTP WhatsApp</title>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        request OTP WhatsApp yang
                                                                        terhubung ke
                                                                        akun Semesta Kita Anda, silahkan masukkan kode
                                                                        OTP berikut untuk menyelesaikan proses yang Anda
                                                                        lakukan.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                                    <h3
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:24px">
                                                                        {{ $otp }}
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                                                        Kode OTP kedaluwarsa pada
                                                                        {{ $expired }}
                                                                        WITA. Abaikan pesan ini jika permintaan OTP
                                                                        WhatsApp bukan
                                                                        bukan dari Anda
                                                                    </p>
