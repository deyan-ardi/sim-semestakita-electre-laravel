...
{{-- Meta --}}
@section('meta-name', 'Statistik Sampah Anorganik')
@section('meta-description', 'Data Statistik Sampah Anorganik')
@section('meta-keyword', 'Statistik Sampah Anorganik')
{{-- End Meta --}}
@section('title', 'Statistik Sampah Anorganik')
@section('content')
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="section-title">Statistik Sampah Anorganik</h3>
                                <div class="line"></div>
                            </div>
                        </div>
                    </div>
                    @php
                        $jml_nonorganik = 0;
                        foreach ($all_sampah_nonorganik as $sampah) {
                            $jml_nonorganik = $jml_nonorganik + $sampah->total_sampah;
                        }
