...
<!-- Mirrored from bootstrap.gallery/unipro/v1-x/01-design-blue/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Aug 2021 12:40:28 GMT -->
...
<body class="fullscreen">
    ...
    <div class="page-wrapper">
        ...
        <div class="main-container">
            {{-- Navbar --}}
            @include('admin.layouts._navbar-fullscreen')
            {{-- End Navbar --}}
