                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title mb-3">
                            Ubah Data Konfigurasi Kriteria Penilaian
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="text-danger mb-3 d-flex justify-content-end">* Wajib Diisi</div>
                        {{-- Form Start --}}
                        <form action="{{ route('konfigurasi.kriteria.update', $find->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="row gutters mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="nama_kriteria" style="text-transform: capitalize;" type="text"
                                        class="form-control"
                                        value="{{ old('nama_kriteria') ? old('nama_kriteria') : $find->nama_kriteria }}"
                                        required>
                                </div>
                            </div>
                            <div class="row">
