...
{{-- Meta --}}
@section('meta-name', 'Master, Ubah Informasi Sistem')
@section('meta-description', 'Data Master, Ubah Informasi Sistem')
@section('meta-keyword', 'Master, Ubah Informasi Sistem')
{{-- End Meta --}}
@section('title', 'Master - Ubah Bantuan dan Informasi Sistem')
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title mb-3">
                            Ubah Data Versi Aplikasi
                        </div>
                    </div>
                    <div class="card-body">
                        {{-- Form Start --}}
                        <div class="text-danger mb-3 d-flex justify-content-end">* Wajib Diisi</div>
                        <form action="{{ route('sistem.info.update', [$find->id]) }}" method="POST">
                            @csrf
                            @method('patch')
                            <div class="row gutters mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="kode" value="{{ old('kode') ?? $find->kode_versi }}"
                            ...
                            <div class="row gutters mb-3">
                                <label class="col-sm-2 col-form-label">Nama Versi <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input name="nama" value="{{ old('nama') ?? $find->nama_versi }}"
                                        style="text-transform: capitalize;" type="text" class="form-control " required>
                                </div>
                            </div>
                            <div class="row gutters mb-3">
                                <label class="col-sm-2 col-form-label">Tanggal Rilis <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input name="date" type="date" value="{{ old('date') ?? $find->tanggal_rilis }}"
                            ...
                            <div class="row gutters mb-3 ck-editor__editable ck-editor__editable_inline">
                                <label class="col-sm-2 col-form-label">Informasi Versi <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <textarea rows="20" name="konten" class="form-control " id="konten">{{ old('konten') ?? $find->konten }}</textarea>
                                </div>
                            </div>
                            <div class="row">
