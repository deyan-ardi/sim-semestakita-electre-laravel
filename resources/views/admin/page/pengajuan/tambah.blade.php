...
{{-- End Meta --}}
@section('title', 'Daftar Permintaan Pengangkutan Sampah - Tambah Data')
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title mb-3">
                            Tambah Data Penjemputan Sampah
                        </div>
                    </div>
                    <div class="card-body">
                        {{-- Form Start --}}
                        ...
                        <form action="{{ route('penjemputan.store') }}" method="POST">
                            ...
                            <div class="row gutters mb-3">
                                <label class="col-sm-2 col-form-label">No. Telepon <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input name="no_telp" value="{{ old('no_telp') }}" type="number" minlength="9"
                                        maxlength="15" onKeyPress="if(this.value.length==10) return false;"
                            ...
                            <div class="row gutters mb-3">
                                <label class="col-sm-2 col-form-label">Lokasi Ambil Sampah <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input name="ambil" value="{{ old('ambil') }}" style="text-transform: capitalize"
                                        type="text" class="form-control " required>
                            ...
                            <div class="row gutters mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input name="jarak" value="{{ old('jarak') }}" type="number" step="0.01"
                                            class="form-control" required>
                                    ...
                                    @if ($config->status == 'active')
                                        <small>Biaya layanan yang dikenakan untuk setiap 1 Km adalah
                                            @currency($config->value). Untuk mengatur biaya layanan, kunjungi fitur master
                                            data</small>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="row gutters mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input name="biaya" value="{{ old('biaya') }}" type="number"
