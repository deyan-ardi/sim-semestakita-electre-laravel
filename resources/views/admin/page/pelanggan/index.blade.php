...
{{-- Meta --}}
@section('meta-name', 'Master Data, Data Pelanggan')
@section('meta-description', 'Data Master Data, Data Pelanggan')
@section('meta-keyword', 'Master Data, Data Pelanggan')
{{-- End Meta --}}
...
@section('footer')
    <script>
        function switchInput(el) {
            ...
            $.ajax({
                url: "{{ route('pelanggan.ubahStatus') }}",
                type: 'POST',
                data: {
                    ids: el,
                    setTo: setTo,
    ...
    <script>
                ...
                Swal.fire({
                    ...
                    .then((result) => {
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('pelanggan.delete.all') }}",
                                method: 'POST',
                                dataType: 'json',
                                data: {
                                    id_user: allVals,
            ...
            if (allVal4.length === 0) {
                ...
                Swal.fire({
                    ...
                    .then((result) => {
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('pelanggan.ubahStatus.all') }}",
                                method: 'POST',
                                dataType: 'json',
                                data: {
                                    id_user: allVal4,
        ...
        const qrCodeMultiple = () => {
            ...
            if (allVals3.length === 0) {
                ...
                Swal.fire({
                        title: 'Apakah Anda Yakin Ingin Mencetak Kode QR Pelanggan Yang Dipilih?',
            ...
            var table = $('.yajra-datatables').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(o) {
                            var deleteField =
                                "{{ route('pelanggan.delete', '') }}" +
                                "/" +
                                o.id;
                            var qrCodeField =
                                "{{ route('pelanggan.cetak.qr', '') }}" +
                                "/" +
                                o.id;
                            var exportOneField =
                                "{{ route('pelanggan.exportone', '') }}" +
                                "/" +
                                o.id;
                            var editField =
                             ...
                             <form id="delete-` + o.id + `" action="` + deleteField + `" method="POST">
                                    ...
                                    <div class="actions">
                                        <a href="` + editField + `"
                                            ...
                                            title="Ubah Pelanggan" data-original-title="Edit">
                                            <i class="icon-edit1 text-info"></i>
                                        </a>
                                        <a target="_blank" rel="noopener noreferrer" href="` + exportOneField + `"
                                            data-toggle="tooltip" data-placement="top"
                                            title="Export Pelanggan" data-original-title="Export">
                                ...
                                .id + `')"  data-toggle="tooltip"
                                            data-placement="top" title="Hapus Pelanggan"
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <h4 class="mb-3">Master - Data Pelanggan</h4>
                <!-- Card start -->
                @if ($errors->any())
                ...
                <div class="card">
                    <div class="card-header-lg">
                        <h4 class="d-flex align-items-center"><i class="icon-people icon-large me-3"></i>Jumlah Pelanggan
                            ({{ $jumlahPelanggan->count() }}), Aktif Membayar
                            ({{ $jumlahPelanggan->where('status_iuran', 1)->count() }}), Tidak Aktif Membayar
                            ({{ $jumlahPelanggan->where('status_iuran', 0)->count() }})</h4>
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <div class="custom-btn-group">
                                        <a href="{{ route('pelanggan') }}" class="btn btn-primary rounded" type="button">
                                ...
                                <div class="col-6">
                                    <div class="d-flex justify-content-end">
                                        <div class="custom-btn-group">
                                            ...
                                            <a href="{{ route('pelanggan.tambah') }}" class="btn btn-primary rounded"
                                                type="button">+
                                                Tambah</a>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        ...
                                                        Dipilih</a>
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        onclick="qrCodeMultiple()">Cetak QR Pelanggan</a>
    ...
    <!-- Row end -->
    <form action="{{ route('pelanggan.export', 'filter') }}" id="ekspor_data" method="POST">
        @csrf
            ...
            <form action="{{ route('pelanggan.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Hanya menerima file dengan
                                ...
                                .xlsx. Download template disini: <a
                                    href="{{ asset('download/format_file_upload_pelanggan.xlsx') }}"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Import Pelanggan</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <!-- Modal end -->
    <form action="{{ route('pelanggan.export', 'select') }}" method="POST" id="ekspor_select">
        @csrf
        <input type="hidden" name="id_user" id="multipleUser">
    </form>
    <form action="{{ route('pelanggan.cetak.qr.multiple') }}" target="_blank" rel="noopener noreferrer" method="POST"
        id="ekspor_qr">
        @csrf
